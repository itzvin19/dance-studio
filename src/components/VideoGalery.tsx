            ...
            <div className="w-full flex flex-col gap-3">
                {visibleVideos.slice(0, 2).map((v) => (
                    <motion.div
                        ...
                        className="w-full bg-primary h-[200px] hover:scale-105 duration-150 cursor-pointer"
                ...
                {selectedVideo && (
                    ...
                    >
                        ...
                        >
                            ...
                            <button onClick={() => setSelectedVideo(null)} className="absolute top-0 right-2 sm:right-12 text-white text-4xl">×</button>
                        </motion.div>
                    </motion.div>
                )}
            </AnimatePresence>
